...
public class RegisterRangerAdministratorController extends AbstractController {
	...
	public RegisterRangerAdministratorController() {
		super();
	}
	...
	protected ModelAndView createEditModelAndView(final Ranger ranger,
		...
		result = new ModelAndView("administrator/register_Ranger");
